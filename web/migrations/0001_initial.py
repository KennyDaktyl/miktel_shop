    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nip_number', models.CharField(blank=True, max_length=13, null=True, validators=[django.core.validators.MinLengthValidator(10)], verbose_name='Numer nip')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_recommended', models.BooleanField(default=False, verbose_name='Czy jest w rekomendowanych')),
                ('is_news', models.BooleanField(default=False, verbose_name='Czy jest w nowościach')),
                ('is_promo', models.BooleanField(default=False, verbose_name='Czy jest w propozycjach')),
                ('is_active', models.BooleanField(default=True, verbose_name='Czy jest dostępny')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_time', models.DateTimeField(auto_now=True, db_index=True)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('image', models.ImageField(upload_to='images/', validators=[web.models.products.file_size])),
                ('alt', models.CharField(blank=True, max_length=125, null=True, verbose_name='Alternatywny text dla obrazka')),
                ('title', models.CharField(blank=True, max_length=70, null=True, verbose_name='Title dla obrazka')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.category', verbose_name='Kategoria artykułu')),
            ],
            options={
