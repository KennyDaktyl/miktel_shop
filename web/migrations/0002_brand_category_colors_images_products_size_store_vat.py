    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', django_resized.forms.ResizedImageField(blank=True, crop=None, force_format=None, keep_meta=True, null=True, quality=0, size=[1280, 960], upload_to='images/categorys/', validators=[web.models.products.file_size], verbose_name='Zdjęcie główne')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_text', models.CharField(max_length=32, verbose_name='Text dla koloru klasy')),
                ('slug', models.SlugField(blank=True, max_length=128, null=True, verbose_name='Slug')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', django_resized.forms.ResizedImageField(blank=True, crop=None, force_format=None, keep_meta=True, null=True, quality=0, size=[1280, 960], upload_to='images/workplace/', validators=[web.models.products.file_size], verbose_name='Zdjęcie główne')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=128, null=True, verbose_name='Slug')),
                ('image', django_resized.forms.ResizedImageField(blank=True, crop=None, force_format=None, keep_meta=True, null=True, quality=0, size=[1280, 960], upload_to='images/products/', validators=[web.models.products.file_size], verbose_name='Zdjęcie główne')),
                ('alt', models.CharField(max_length=125, verbose_name='Alternatywny text dla obrazka')),
                ('title', models.CharField(blank=True, max_length=70, null=True, verbose_name='Title dla obrazka')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.category', verbose_name='Kategoria produktu')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('image', django_resized.forms.ResizedImageField(crop=None, force_format=None, keep_meta=True, quality=0, size=[1280, 960], upload_to='images/', validators=[web.models.products.file_size])),
                ('alt', models.CharField(blank=True, max_length=125, null=True, verbose_name='Alternatywny text dla obrazka')),
                ('title', models.CharField(blank=True, max_length=70, null=True, verbose_name='Title dla obrazka')),
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_gallery', to='web.products', verbose_name='Zdjęcie produktu')),
            ],
            options={
