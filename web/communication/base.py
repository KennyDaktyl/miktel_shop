...
def send_email(subject='', body='', body_html='', from_email=None, to=None, cc=None,  # TODO: bcc?
    ...
    headers = {'Message-ID': msg_id}  # TODO: check in Sendgrid if emails can be tracked somehow, delivery status etc.
    msg = EmailMultiAlternatives(
        subject=subject, body=body, from_email=from_email, to=to, cc=cc, reply_to=reply_to,
