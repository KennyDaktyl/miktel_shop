...
class ShopMainView(View):
    def get(self, request):
        ...
        ctx = {'cat': cat, 'products': products, 'title': title, 'description': description}
...
class SubCategoryProducts(View):
    def get(self, request ,cat, sub_cat):
        ...
        title = ""
        description = ""
        ctx = {'sub_cat': sub_cat, 'products': products, 'title': title, 'description': description}
        return render(request, "products/products_list.html", ctx)
...
class SubCategoryTypeProducts(View):
    def get(self, request ,cat, sub_cat, sub_cat_type):
        ...
        description = "Produkty z kategorii: " + sub_category_type.sub_category.name + " | " + sub_category_type.name
        ctx = {'sub_category_type': sub_category_type, 'products': products, 'title': title, 'description': description}
        return render(request, "products/products_list.html", ctx)
